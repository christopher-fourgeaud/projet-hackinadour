<!-- Modal -->
<div id="modalp2" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <!-- Titre modal produit 2 -->
                <h4 class="modal-title text-center">Chambre de combustion</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <img class="productModal" src="assets/images/product2.jpg" alt="">
                    </div>
                </div>
                <div class="row">
