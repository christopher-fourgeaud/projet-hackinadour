<?php include("template/modalp1.php") ?>
<?php include("template/modalp2.php") ?>
<?php include("template/modalp3.php") ?>
...
<div class="row">
    <div class="row">
        <div class="col-md-2 col-md-offset-5">
            <u><h4 class="text-center titre2">Nos solutions</h4></u>
            <br>
        </div>
    </div>
    <!-- Début premier produit -->
    <div class="col-md-4 col-md-offset-1 col-xs-12 produit">
        <div class="row">
            <br>
            <div class="col-md-4">
            ...
            <div class="col-md-7">
                <!-- Titre du produit -->
                <a data-toggle="modal" data-target="#modalp1" href="#">
                    <u><h4 class="text-center titre">C.E.P.S.</h4></u>
                </a>
            </div>
        </div>
        <br>
    ...
    <div class="col-md-4 col-md-offset-2 col-xs-12 produit">
        <div class="row">
            <br>
            <div class="col-md-4">
                <img class="product" src="assets/images/product2.jpg" alt="Produit n°1">
            </div>
            <div class="col-md-7">
                <!-- Titre du produit -->
...
<div class="row">
    <br>
    <!-- Début troisème produit -->
    <div class="col-md-4 col-md-offset-1 col-xs-12 produit">
        <div class="row">
            <br>
            <div class="col-md-4">
                <img class="product" src="assets/images/product3.jpg" alt="Produit n°1">
            </div>
            <div class="col-md-7">
                <!-- Titre du produit -->
                <a data-toggle="modal" data-target="#modalp3" href="">
                    <u>
                        <h4 class="text-center titre">Filtre Céramique Régénérable</h4>
                    </u>
                </a>
            </div>
        </div>
